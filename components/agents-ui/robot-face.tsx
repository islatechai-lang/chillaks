  ...
  return (
    <div className={cn("fixed inset-0 z-0 flex items-center justify-center overflow-hidden bg-black w-screen h-screen", className)}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="mt-[55%] flex items-center justify-center w-[200px] h-40 pointer-events-none translate-x-[4px]">
          ...
          >
            ...
            <path
              ...
              d={`
                  M 0 50 
                  Q 50 ${isSpeaking ? 50 - (Math.max(0, volume - 0.03) * 110) : 49.5} 100 50 
                  Q 50 ${isSpeaking ? 50 + (Math.max(0, volume - 0.03) * 110) : 50.5} 0 50 
                  Z
                `}
              fill="black"
              fillOpacity="1" // Solid black inside
